...
@TaggerRegistry.add("jigsaw_hatespeech_document_v1")
class FastTextJigsawHatespeechDocumentTagger(BaseFastTextTagger):
    ...
    def predict_slice(self, text_slice: TextSlice) -> Prediction:
        ...
        return Prediction(label=labels[label_index], score=probs[label_index])


@TaggerRegistry.add("jigsaw_hatespeech_sentence_v1")
...
@TaggerRegistry.add("jigsaw_nsfw_sencence_v1")
