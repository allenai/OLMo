...
srun \
  ...
  scripts/run_with_environment.sh \
    ...
    python scripts/train.py configs/qkv-v1_5-mix-medium-mitch-ish.yaml ${@} \
      ...
      --wandb.name=qkv-clip \
      --wandb.group=qkv-clip \
      --model.clip_qkv=8.0 \
      --save_interval=1000 \
      --save_interval_ephemeral=1000 \
      --remote_save_folder=s3://ai2-llm/checkpoints/olmo7-ablation/qkv-clip \
      --save_folder=${FLASH_DIR}/checkpoints/qkv-clip \
      ${@}
