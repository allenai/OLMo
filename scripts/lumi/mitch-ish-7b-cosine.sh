#!/bin/bash
#SBATCH --job-name=mitchish-cosine
...
srun \
  ...
  scripts/run_with_environment.sh \
    ...
    python scripts/train.py configs/v1_5-mix-medium-mitch-ish.yaml ${@} \
      ...
      --wandb.name=v1_5-mix-mitch-ish-lumi-cosine \
      --save_interval=10000 \
      --save_interval_ephemeral=1000 \
      --remote_save_folder=s3://ai2-llm/checkpoints/7b/mitchish-lumi-cosine \
      --save_folder=${FLASH_DIR}/checkpoints/mitchish-lumi-cosine \
      --save_overwrite
