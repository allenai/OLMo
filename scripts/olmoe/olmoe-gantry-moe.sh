...
CONFIG_PATH=configs/olmoe17/olmoe17-8x1b-fullshard-swiglu-wrapb-k2-zloss.yml
ARGS='--run_name=olmoe17-8x1b-fullshard-swiglu-wrapb-k2-zloss --load_path=s3://ai2-llm/checkpoints/OLMoE/olmoe17-8x1b-fullshard-swiglu-wrapb-k2-zloss/step205000/ --save_overwrite --fused_loss=true --activation_checkpointing=fine_grained --device_train_microbatch_size=4'
