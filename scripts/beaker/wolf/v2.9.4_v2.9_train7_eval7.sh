...
NUM_NODES=1
RUN_NAME="v2.9.4_v2.9_train7_eval7"
...
gantry run \
  ...
  -- /bin/bash -c "\
    ...
    torchrun --nnodes ${NUM_NODES}:${NUM_NODES} --nproc-per-node 8 \
        ...
        --max_duration=11224 \
        --infgram.index_dir=/weka/oe-training-default/wolf/index/v5_dolma-v1_7_olmo/0 --infgram.prefetch=true --model.separate_infgram_wte=true --infgram.method_train=7 --infgram.method_eval=7 \
    "
