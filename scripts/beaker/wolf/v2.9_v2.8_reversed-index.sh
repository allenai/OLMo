...
NUM_NODES=1
RUN_NAME="v2.9_v2.8_reversed-index"
...
gantry run \
  ...
  -- /bin/bash -c "\
    ...
    torchrun --nnodes ${NUM_NODES}:${NUM_NODES} --nproc-per-node 8 \
        ...
        --max_duration=11224 \
        --infgram.index_dir=/weka/oe-training-default/wolf/index/v5_dolma-v1_7_olmo/0 --infgram.prefetch=true --infgram.separate_wte=true \
    "
