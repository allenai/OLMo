...
gantry run \
  ...
  -- /bin/bash -c "\
    ...
    torchrun --nnodes ${NUM_NODES}:${NUM_NODES} --nproc-per-node 8 --rdzv_id=20310 --rdzv_backend=static --rdzv_conf='read_timeout=1200' --rdzv_endpoint=\$BEAKER_LEADER_REPLICA_HOSTNAME:29400 --node_rank=\$BEAKER_REPLICA_RANK \
        ...
        --infgram.index_dir=/weka/oe-training-default/wolf/index/v5_dolma-v1_7_olmo --infgram.sharded=true --infgram.prefetch=true --infgram.separate_wte=true --infgram.method_train=5 --infgram.method_eval=5 \
    "
