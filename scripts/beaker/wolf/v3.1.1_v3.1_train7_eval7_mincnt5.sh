...
NUM_NODES=1
RUN_NAME="v3.1.1_v3.1_train7_eval7_mincnt5"
...
gantry run \
  ...
  -- /bin/bash -c "\
    ...
    torchrun --nnodes ${NUM_NODES}:${NUM_NODES} --nproc-per-node 8 \
        ...
        --max_duration=12202 \
        --infgram.index_dir=/weka/oe-training-default/wolf/index/v5_olmoe-mix-0924_dolma2/0 --infgram.prefetch=true --model.separate_infgram_wte=false --infgram.method_train=7 --infgram.method_eval=7 --infgram.min_cnt=5 --infgram.dtype=u32 \
    "
