...
gantry run \
  ...
  --task-name peteish1-b384-lr5.2e-4 \
  --description "Pete-ish 1B, batch_size 384, lr 5.2e-4" \
  --priority high \
  ...
  -- /bin/bash -c "\
    ...
    torchrun \
        ...
        scripts/train.py \
            ...
            --run_name="peteish1-b384-lr5.2e-4" \
            --save_interval_ephemeral=null \
            --save_overwrite \
            --load_path=\\\${path.last_checkpoint:\\\${save_folder}} \
            --global_train_batch_size=384 --optimizer.learning_rate=5.2e-4 \
    "
