...
gantry run \
  ...
  --task-name peteish1-anneal-from-500000 \
  --description "Pete-ish 1B, anneal from 500000" \
  --priority high \
  ...
  -- /bin/bash -c "\
    ...
    torchrun \
        ...
        scripts/train.py \
            ...
            --run_name="peteish1-anneal-from-500000" \
            --save_interval_ephemeral=null \
            --save_overwrite \
            --load_path=/weka/oe-training-default/ai2-llm/checkpoints/OLMo-small/peteish1/step500000 \
