...
torchrun \
  ...
  scripts/train.py \
  configs/mitchish1-s3-cheap-decisions-r70b-baseline-sources-3x-code.yaml \
    --load_path='${path.last_checkpoint:s3://ai2-llm/checkpoints/cheap_decisions/dolma-v1-6-and-sources-baseline-3x-code-1B-N-1T-D-mitchish1-001}' \
