...
torchrun \
  ...
  scripts/train.py \
  configs/llamaish7-s3.yaml \
    --run_name=llamaish7-detailed-no-fsdp \
    --wandb.name=llamaish7-detailed-no-fsdp \
    --wandb.group=llamaish7-detailed-no-fsdp \
    --model.flash_attention=true \
    --save_folder=/net/nfs.cirrascale/allennlp/shanea/checkpoints/llamaish7-detailed-no-fsdp/ \
    ...
    --save_overwrite \
    --load_path=/net/nfs.cirrascale/allennlp/shanea/checkpoints/llamaish7-detailed/step2800
