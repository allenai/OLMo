...
CONFIG_PATH=configs/annealing/v0-step_1.5T-warmup_true-flan_false.yaml
NUM_NODES=8

gantry run \
  --allow-dirty \
  --workspace ai2/davidw-oe-annealing \
  --task-name v0-step_1.5T-warmup_true-flan_false \
  --description v0-step_1.5T-warmup_true-flan_false \
  --priority high \
