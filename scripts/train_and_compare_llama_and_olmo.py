...
from olmo.checkpoint import save_fsdp_model_and_optim_state
...
checkpoint_dir = "/home/yulingg/models/llama-7b-olmo-obj" #"/Users/yulingg/models/llama-7b-olmo-obj"
olmo_optimizer = build_optimizer(config, olmo_model)
save_fsdp_model_and_optim_state(checkpoint_dir, olmo_model, olmo_optimizer)

## Check for this saving stage
log.info("SAVED MODEL FROM MONSTER!")
