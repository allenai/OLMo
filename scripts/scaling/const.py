# python scripts/scaling/const.py -c scripts/scaling/const.json -k c4 -o figure/peteish-moreeval-const/const_c4.png
# python scripts/scaling/const.py -c scripts/scaling/const.json -k hellaswag_val_5shot -o figure/peteish-moreeval-const/const_hellaswag.png
# python scripts/scaling/const.py -c scripts/scaling/const.json -k mmlu_avg_test_5shot -o figure/peteish-moreeval-const/const_mmlu.png
