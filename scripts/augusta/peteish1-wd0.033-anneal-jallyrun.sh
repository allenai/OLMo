...
torchrun \
  ...
  scripts/train.py \
    configs/annealing/peteish1-anneal-jallyrun.yaml \
      --run_name=$RUN_NAME \
      --wandb.group=$NAME \
      ...
      --load_path="gs://ai2-llm/checkpoints/OLMo-small/peteish1-wd0.033-augusta/step1907359" \
      --save_overwrite \
      ...
      --optimizer.weight_decay=0.033 \
      --optimizer.learning_rate=0.000074487
